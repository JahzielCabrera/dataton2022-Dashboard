...
export default function AnomaliasDeclaracionFuncionario() {
    ...
    useEffect(() => {
        ...
        const getTotalCargoPublico = () => {
            try {
                if(declaracion.declaracion.situacionPatrimonial.ingresos.remuneracionMensualCargoPublico.valor) {
                    ...
                    setTotalIngresosCargoPublico('NO ENCONTRADO')
                }              
            } catch (error) {
                setTotalIngresosCargoPublico('NO ENCONTRADO')
            }
        ...
        const getData = async () => {
            ...
            console.log(anomaliasData.data)
                ...
                <Box sx={{mt:2, display: 'flex', flexDirection: 'row'}}>
                    ...
                    <Box sx={{width: '50%'}}>
                        <Typography sx={{fontSize:35, fontWeight:900}}><span style={{fontWeight:300, fontSize:20}}>INGRESOS MENSUALES: </span> 
                            {Number(declaracion?.declaracion?.situacionPatrimonial?.ingresos?.totalIngresosMensualesNetos?.valor || declaracion?.declaracion?.situacionPatrimonial?.ingresos?.totalIngresosAnualesNetos?.valor).toLocaleString("en-US", {minimumFractionDigits:2, maximumFractionDigits:2}) + ' MXN'}
